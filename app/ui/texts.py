...
DADATA_INTRO_TEXT = (
    "Введите ИНН, ОГРН/ОГРНИП или наименование организации.\n\n"
    "Примеры:\n"
    "• 7707083893\n"
    "• Сбербанк"
)

DADATA_EMPTY_QUERY_TEXT = "Введите ИНН, ОГРН/ОГРНИП или наименование организации."

DADATA_INVALID_QUERY_TEXT = (
    "Не удалось распознать запрос.\n"
    "Введите корректный ИНН, ОГРН/ОГРНИП или наименование организации."
)

DADATA_NOT_FOUND_TEXT = (
    "По вашему запросу ничего не найдено.\n"
    "Попробуйте уточнить ИНН, ОГРН/ОГРНИП или наименование."
)
...
DADATA_CONTINUE_HINT = "Чтобы выполнить новый поиск, отправьте ИНН, ОГРН/ОГРНИП или наименование организации."
...
DADATA_BATCH_INTRO_TEXT = (
    ...
    "Требования к файлу:\n"
    "• от 1 до 3 колонок: ИНН и/или ОГРН(ОГРНИП) и/или наименование\n"
    "• названия колонок не важны\n"
    "• можно передавать любые комбинации: только ИНН, только ОГРН, только название, или смешанно\n\n"
